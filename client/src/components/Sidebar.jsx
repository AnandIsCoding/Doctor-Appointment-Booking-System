...
function Sidebar() {
  ...
  return (
    <div className={`fixed  ${isOpen ? "w-[15%]  md:w-[15%] mt-[20vw] md:mt-2" : "md:w-[5%] mt-[20vw] md:mt-2"} min-h-screen bg-[#004D43] ml-0 md:ml-4  mt-2 rounded-md z-[999] px-3 py-5 flex flex-col gap-2 transition-all duration-300 ease-in-out  `}>
    {/* open close arrow */}
  ...
  {/* image icon */}
       ...
       {
            isOpen ?  <button className='w-full bg-white px-2 mr-2 md:mr-0 md:px-20  py-2 rounded-lg cursor-pointer '>Logout</button> : <AiOutlineLogout
              size={30}
