...
function MultiStepDescription() {
  ...
  return (
    <div className="w-full mt-5 md:px-10">
      ...
      <div className="w-full p-5 md:px-20 md:py-10 flex flex-col bg-white text-black border-2 border-green-100 rounded-lg shadow-lg mt-5 items-center justify-center">
        <h1 className="text-2xl font-bold text-green-800 uppercase">
          {multiStepData.find((item) => item.id === showText)?.title}
        </h1>
        
        {/* Horizontal divider */}
        <span className="w-full h-[1px] bg-green-900 rounded-xl my-4"></span>
        <br></br> 
