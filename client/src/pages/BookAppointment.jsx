...
function BookAppointment() {
  ...
  return (
    ...
    <div className={`w-full mt-14 pl-0  ${isOpen ? "pl-0 md:pl-[11%] " : "pl-0 md:pl-[6%]"} `}> 

        {/* filter doctors */}
         {/* categories specialization options */}
      <div
        className={`w-full md:px-2 md:justify-center ${isOpen ? " pl-0 md:pl-[18%] " : "pl-0 md:pl-[5%]"} mb-3 pl-0  py-2 text-white flex gap-2 overflow-x-scroll relative`}
      >
        {[
"All",
"General Physician",
...
.map((specialization) => (
          ...
          {/* all doctors card */}
       <div className={`w-full pb-34 md:pb-8  flex flex-wrap justify-center items-stretch gap-4 px-2 ${isOpen ? "md:pl-[18%] pl-0" : "md:pl-[5%]"}`}>
